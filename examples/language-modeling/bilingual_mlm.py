...
class ModelArguments:
    ...
    num_hidden_layers: Optional[int] = field(
        default=None,
        metadata={"help": "Overrides config's number of hidden layers."},
    )
...
def main():
    ...
    if model_args.num_hidden_layers:
        config_kwargs['num_hidden_layers'] = model_args.num_hidden_layers
    ...
    if model_args.model_name_or_path:
        ...
        model = auto_model_type.from_config(
            config=config,
        )

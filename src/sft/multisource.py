...
def MultiSourcePlugin(_Trainer):
    ...
    class _MultiSourceTrainer(_Trainer):
        ...
        def training_step(self, model, inputs, num_items_in_batch=None):
            ...
            # Call parent with num_items_in_batch if provided (newer transformers)
        ...
        def _save(self, output_dir, state_dict=None):
            ...
            # This fixes safetensors issues with non-contiguous tensors from model compression
            ...
            return super()._save(output_dir, state_dict=contiguous_state_dict)
